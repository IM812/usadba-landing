...
const fallbackFaq = [
  ...
  },
  {
    ...
    answer: "В стоимость входит проживание, постельное бельё и полотенца, пользование баней, чаном, лодкой, сап-бордами, велосипедами. Дрова для бани — по запросу. Уборка перед заездом включена.",
  },
  {
  ...
  {
    question: "Как протекает процесс бронирования?",
    answer: "Оставьте заявку через форму на сайте или напишите напрямую. Мы подтверждаем даты и договариваемся об оплате. Усадьба считается забронированной после внесения предоплаты.",
  },
]
